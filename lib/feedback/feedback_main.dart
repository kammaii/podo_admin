...
import 'package:podo_admin/feedback/feedback_state_manager.dart';
      ...
      Get.dialog(AlertDialog(
        ...
        actions: [
          ElevatedButton(onPressed: () async {
            Get.back();
            Get.back();
            await Database().updateField(collection: 'Lessons/${fb.lessonId}/LessonCards', docId: fb.cardId, map: {'content.${fb.language}':feedback});
                            ...
                            return DataRow(cells: [
                              ...
                              DataCell(Text(feedback.feedback), onTap: () async {
                                DocumentSnapshot<Map<String, dynamic>> snapshot = await Database().getDoc(
                                    collection: 'Lessons/${feedback.lessonId}/LessonCards', doc: feedback.cardId);
                                      ...
                                      children: [
                                        ...
                                        Expanded(
                                          child: Container(
                                            ...
                                            child: MyTextField().getTextField(controller: TextEditingController(text: feedback.feedback)),
                                          ),
                                        ),
                              ...
                              DataCell(Icon(Icons.circle, color: feedback.isChecked ? Colors.green : Colors.red)),
                              DataCell(
                                IconButton(
                                  icon: const Icon(
                                    Icons.delete,
